...
-- CreateTable
CREATE TABLE "TablaProduco" (
    "id" TEXT NOT NULL,
    "codProducto" TEXT NOT NULL,
    "nombreProducto" TEXT NOT NULL,

    CONSTRAINT "TablaProduco_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "RelProdInver" (
    "tablaInversionistaId" TEXT NOT NULL,
    "tablaProducoId" TEXT NOT NULL,

    CONSTRAINT "RelProdInver_pkey" PRIMARY KEY ("tablaInversionistaId","tablaProducoId")
);
...
CREATE TABLE "RelProdCate" (
    ...
    CONSTRAINT "RelProdCate_pkey" PRIMARY KEY ("tablaProducoId","tablaCategoriaId")
);
...
CREATE TABLE "RelProdCateInver" (
    ...
    CONSTRAINT "RelProdCateInver_pkey" PRIMARY KEY ("tablaProducoId","tablaCategoriaId","tablaInversionistaId")
);
...
-- AddForeignKey
ALTER TABLE "RelProdInver" ADD CONSTRAINT "RelProdInver_tablaProducoId_fkey" FOREIGN KEY ("tablaProducoId") REFERENCES "TablaProduco"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TablaDocumento" ADD CONSTRAINT "TablaDocumento_tablaProducoId_fkey" FOREIGN KEY ("tablaProducoId") REFERENCES "TablaProduco"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RelProdCate" ADD CONSTRAINT "RelProdCate_tablaProducoId_fkey" FOREIGN KEY ("tablaProducoId") REFERENCES "TablaProduco"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RelProdCateInver" ADD CONSTRAINT "RelProdCateInver_tablaProducoId_fkey" FOREIGN KEY ("tablaProducoId") REFERENCES "TablaProduco"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
